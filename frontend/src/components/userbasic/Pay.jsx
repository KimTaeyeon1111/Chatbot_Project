                ...
                <div className="pay-start">
                    ...
                    <div className="pay-start-right">
                        ...
                        <div className="pay-box-right-2">
                            <p>소유자 이름</p>
                            <Form.Control size="sm" type="text" placeholder="이름을 입력해주세요." className="pay-box-right-form" />
                        </div>
                        <div className="pay-box-right-3">
                            <p>카드 번호</p>
                            <Form.Control size="sm" type="text" placeholder="카드 번호를 입력해주세요." className="pay-box-right-form" />
                        </div>
                        <div className="pay-box-right-4">
                            <p>만료 월/년도</p>
                            <Form.Control size="sm" type="text" placeholder="카드 만료일을 입력해주세요." className="pay-box-right-form" />
                        </div>
                        <div className="pay-box-right-5">
                            <p>CVC</p>
                            <Form.Control size="sm" type="text" placeholder="CVC 번호를 입력해주세요." className="pay-box-right-form" />
                        </div>
                    </div>
                </div>
                <div>
